...
SWIGINTERN PyObject *_wrap_hello(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  swig_obj[0] = args;
  {
    ...
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "hello" "', argument " "1"" of type '" "string""'"); 
    }  
    if (!argp1) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "hello" "', argument " "1"" of type '" "string""'");
    } else {
...
SWIGINTERN PyObject *_wrap_introduce(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  
  if (!SWIG_Python_UnpackTuple(args, "introduce", 0, 0, 0)) SWIG_fail;
  introduce();
  resultobj = SWIG_Py_Void();
  return resultobj;
fail:
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "hello", _wrap_hello, METH_O, NULL},
	 { "introduce", _wrap_introduce, METH_NOARGS, NULL},
